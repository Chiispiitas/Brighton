  ...
  pages: [
    {
      ...
      questions: [
        ...
        q(2, "You can collect these or use them to buy something.", "coins", "stamps", "bracelets"),
        q(3, "This is a room where you cook.", "bathroom", "kitchen", "garage"),
        q(4, "This is where you can go to see big sports events.", "theater", "stadium", "gallery"),
        q(5, "Meat, fish, and cheese all contain this.", "protein", "sugar", "fiber"),
        q(6, "We usually buy cereal in a packet or a ________.", "bottle", "box", "jar"),
        q(7, "We keep our milk cold in the ________.", "fridge", "stove", "cabinet"),
        ...
        q(10, "This room usually has a sofa, some armchairs, and often a TV.", "living room", "kitchen", "study"),
        ...
        q(13, "I ________ to college three years ago.", "went", "go", "goes"),
    ...
    },
    {
      ...
      questions: [
        ...
        q(19, "I have a lot of cabinets and ________ in my room for my books.", "shelves", "stairs", "sofas"),
        q(20, "I like ________ furniture, but my parents prefer traditional styles.", "modern", "metal", "messy"),
        q(21, "I like vegetable soup. My favorite is ________ soup, but I like carrot soup, too.", "mushroom", "meat", "milk"),
        q(22, "Can I have a ________ of chocolate, please?", "packet", "piece", "bottle"),
        q(23, "I hate using the ________ at home. It cleans the floor, but it's very noisy!", "vacuum cleaner", "video camera", "washing machine"),
        q(24, "We got home and ________ dinner immediately.", "ate", "added", "asked"),
        q(25, "It wasn't very warm yesterday, so Jonathan wore ________ to work instead of shorts.", "pants", "pajamas", "purses"),
        q(26, "I put my jeans in the washing machine this morning. They were really ________.", "dry", "dark", "dirty"),
        q(27, "Choose the corrected sentence.", "I'm sorry, but I can't help you.", "I'm sorry, but I can't helping you.", "I'm sorry, but I can't to help you."),
