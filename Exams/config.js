...
window.BRIGHTON_SITE_CONFIG = {
  ...
  FALLBACK_TESTS: [
    ...
    },
    {
      ...
      level: "A1",
      unitRange: "5-6",
      description: "Two-page A1 multiple-choice test using Unit 5 page 1 and Unit 6 page 2.",
      isActive: true,
      totalQuestions: 40,
      maxScore: 40,
    ...
    },
    {
      ...
      level: "A1",
      unitRange: "5-7",
      description: "Four-page A1 multiple-choice progress test covering vocabulary, grammar, language in context, and reading from Units 5–7.",
      isActive: true,
      totalQuestions: 80,
      maxScore: 80,
    ...
    },
    {
      ...
      level: "A1",
      unitRange: "9-10",
      description: "Two-page A1 multiple-choice test using Unit 9 page 1 and Unit 10 page 2.",
      isActive: true,
      totalQuestions: 40,
      maxScore: 40,
